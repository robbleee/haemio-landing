...
const OUTPUT_PATH = path.join(__dirname, '../public/Haem.io-pitch-1m.pdf');
const VIEWPORT = { width: 1620, height: 1080, deviceScaleFactor: 2 };

async function generatePitchPDF() {
  console.log(`Connecting to ${BASE_URL}/p/deck ...`);
  ...
  // Navigate to the £1M pitch deck
  await page.goto(`${BASE_URL}/p/deck`, {
