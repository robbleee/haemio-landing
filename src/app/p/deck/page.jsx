...
const pitchSlides = [
      ...
      <div className={styles.slideContent}>
        <div className={styles.titleSlide}>
          <div className={styles.titleMain}>
            ...
            <div className={styles.seedBadge}>Seed Round: £1,000,000</div>
          </div>
  ...
  },
  {
    id: 11,
    title: "The Ask",
    subtitle: "£1M seed round. 18 months to Series A.",
    content: (
      <div className={styles.slideContent}>
        <div className={styles.runwayLayout}>
          <div className={styles.runwayTotal}>
            <div className={styles.totalAmount}>£1,000,000</div>
            ...
            <div className={styles.runwaySection}>
              ...
              <div className={styles.runwayItems}>
                <div className={styles.runwayItem}>
                  ...
                  <span className={styles.runwayAmount}>£220k</span>
                </div>
                <div className={styles.runwayItem}>
                  <span>Compliance Officer</span>
                  <span className={styles.runwayAmount}>£140k</span>
                </div>
                <div className={styles.runwayItem}>
              ...
              <div className={styles.sectionTotal}>£560k</div>
            </div>
            ...
            <div className={styles.runwaySection}>
              ...
              <div className={styles.runwayItems}>
                <div className={styles.runwayItem}>
                  ...
                  <span className={styles.runwayAmount}>£55k</span>
                </div>
                <div className={styles.runwayItem}>
              ...
              <div className={styles.sectionTotal}>£160k</div>
            </div>
            ...
            <div className={styles.runwaySection}>
              ...
              <div className={styles.runwayItems}>
                ...
                <div className={styles.runwayItem}>
                  ...
                  <span className={styles.runwayAmount}>£160k</span>
                </div>
              </div>
              <div className={styles.sectionTotal}>£280k</div>
            </div>
          </div>
      ...
      <div className={styles.slideContent}>
        <div className={styles.ctaSlide}>
          ...
          <div className={styles.ctaBadge}>
            Raising £1,000,000 to transform haematology diagnosis
          </div>
